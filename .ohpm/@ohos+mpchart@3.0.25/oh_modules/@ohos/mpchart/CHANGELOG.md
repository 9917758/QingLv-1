## 3.0.25
- Release memory when exiting the chart

## 3.0.24
- Release official version

## 3.0.24-rc.0
- Fix cannot read property createAnimator of undefined

## 3.0.23
- Release official version

## 3.0.23-rc.2
- Fix the issue of memory leak in pixelmap
...
## 3.0.22
- Change the code repository address

## 3.0.21
- Fix the issue of cannot read property setPhases of undefined
- Fix the issue of a single data point without fill color
